...
hexo.extend.filter.register('before_generate', () => {
  ...
  const defaultCDN = {
    ...
    sharejs: '/js/social-share/js/social-share.min.js',
    sharejs_css: '/js/social-share/css/share.min.css',
    ...
    // background effect
    canvas_ribbon: '/js/extsrc/canvas-ribbon.min.js',
    ...
    // photo
    fancybox_css_v4: '/js/fancyapps/fancybox.css',
    fancybox_v4: '/js/fancyapps/fancybox.umd.js',
    medium_zoom:
    ...
    // fontawesome
    fontawesomeV6:
      'https://cdn.staticfile.org/font-awesome/6.1.1/css/all.min.css',
